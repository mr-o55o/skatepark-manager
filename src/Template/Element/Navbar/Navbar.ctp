  	...
  	<div class="collapse navbar-collapse text-right" id="'navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
		 	...
		 	<li class="nav-item <?= ($active == 'Events' ? 'active' : '') ?>">
		  	...
		  	<li class="nav-item <?= ($active == 'AthletesManagement' ? 'active' : '') ?>">
		  		<?= $this->Html->link(__('Athletes Management'), ['controller' => 'Athletes', 'action' => 'index'], ['class' => 'nav-link text-white'])?>
		  	</li>
		  	<li class="nav-item <?= ($active == 'LessonsManagement' ? 'active' : '') ?>">
		  		<?= $this->Html->link(__('Lessons Management'), ['controller' => 'LessonEditions', 'action' => 'indexBooked'], ['class' => 'nav-link text-white'])?>
		  	</li>
		  	<li class="nav-item <?= ($active == 'ActivitiesManagement' ? 'active' : '') ?>">
		  		<?= $this->Html->link(__('Activities Management'), ['controller' => 'Activities', 'action' => 'indexUpcoming'], ['class' => 'nav-link text-white'])?>
		  	</li>
		  	<li class="nav-item <?= ($active == 'Administration' ? 'active' : '') ?>">
