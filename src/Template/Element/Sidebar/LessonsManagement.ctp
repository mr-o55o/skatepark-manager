...
<div class="list-group bg-dark">
	...
	<!-- Active Lesson Editions Bundles Index Link -->
	<?= $this->Html->link(__('Active Lesson Editions Bundles'), 
	...
	<?= $this->Html->link(__('Purchased Lesson Editions Bundles'), 
			...
			['class' => 'list-group-item list-group-item-action bg-secondary text-white ' . ($this->request->action == 'index' && $this->request->controller == 'PurchasedLessonEditionsBundles' ? 'active' : '')]
		); 
