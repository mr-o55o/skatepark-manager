    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $province->code]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $province->code]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $province->code], ['confirm' => __('Are you sure you want to delete # {0}?', $province->code)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
