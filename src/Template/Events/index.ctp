    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('lesson_edition_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $event->has('lesson_edition') ? $this->Html->link($event->lesson_edition->id, ['controller' => 'LessonEditions', 'action' => 'view', $event->lesson_edition->id]) : '' ?></td>
                <td class="actions">
