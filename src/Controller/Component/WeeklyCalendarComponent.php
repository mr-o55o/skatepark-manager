 ...
 */
class WeeklyCalendarComponent extends Component {
	 ...
	 * @param $month day
	 * @param $day day
	 * @param int $span Months in both directions
	 * @return void
	 * @throws \Cake\Http\Exception\NotFoundException
	 */
	public function init($year, $month, $day, $span = 10) {
		if (!is_numeric($month)) {
		...
		$this->Controller->set('_weeklyCalendar', ['year' => $this->year, 'month' => $this->month, 'span' => $span]);
	}
