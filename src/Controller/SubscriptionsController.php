...
class SubscriptionsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Athletes', 'SubscriptionStatuses', 'SubscriptionTypes']
        ];
    ...
    public function view($id = null)
    {
        $subscription = $this->Subscriptions->get($id, [
            'contain' => ['Athletes', 'SubscriptionStatuses', 'SubscriptionTypes', 'SelectedCourseEditions']
        ]);
    ...
    public function add()
    {
        ...
        $athletes = $this->Subscriptions->Athletes->find('list', ['limit' => 200]);
        $subscriptionStatuses = $this->Subscriptions->SubscriptionStatuses->find('list', ['limit' => 200]);
        $subscriptionTypes = $this->Subscriptions->SubscriptionTypes->find('list', ['limit' => 200]);
        $this->set(compact('subscription', 'athletes', 'subscriptionStatuses', 'subscriptionTypes'));
    }
